...
def _update_model_from_server(
    ...
    if new_model_fingerprint:
        ...
        project.update_model_from_dir_and_unload_others(
...
class Project(object):
    ...
    def update_model_from_dir_and_unload_others(
        ...
        logger.debug(
            "Loading model '{}' from directory '{}'.".format(
    ...
    def _list_models_in_cloud(self) -> List[Text]:
        ...
        try:
            ...
            logger.warning(
                "Failed to list models of project {}. "
    ...
    def _load_model_from_cloud(self, model_name, target_path):
        try:
            ...
            logger.warning(
                "Using default interpreter, couldn't fetch "
                "model: {}".format(e)
            )
