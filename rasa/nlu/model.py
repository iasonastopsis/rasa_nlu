...
class Metadata(object):
    ...
    def for_component(self, index, defaults=None):
        return component_config_from_pipeline(
...
class Trainer(object):
    ...
    def train(self, data: TrainingData, **kwargs: Any) -> "Interpreter":
        ...
        for i, component in enumerate(self.pipeline):
            logger.info(
                "Starting to train component {}" "".format(component.name)
            )
...
class Interpreter(object):
    ...
    def load(
        ...
        return Interpreter.create(
            model_metadata, component_builder, skip_validation
        )
