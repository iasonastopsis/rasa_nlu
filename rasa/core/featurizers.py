...
class BinarySingleStateFeaturizer(SingleStateFeaturizer):
    ...
    def prepare_from_domain(self, domain: Domain) -> None:
        ...
        self.user_feature_len = len(domain.intent_states) + len(
...
class TrackerFeaturizer(object):
    ...
    def training_states_and_actions(
        ...
        raise NotImplementedError(
            "Featurizer must have the capacity to "
    ...
    def training_states_and_actions(
        ...
        for tracker in pbar:
            states = self._create_states(
                tracker, domain, is_binary_training=True
            )
        ...
        logger.debug(
            "The longest dialogue has {} actions." "".format(self.max_len)
        )
...
class MaxHistoryTrackerFeaturizer(TrackerFeaturizer):
    ...
    def training_states_and_actions(
        ...
        logger.debug(
            "Created {} action examples." "".format(len(trackers_as_actions))
        )
