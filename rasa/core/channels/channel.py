...
class OutputChannel(object):
    ...
    async def send_response(
        ...
        if message.get("elements"):
            await self.send_custom_message(
                recipient_id, message.get("elements")
            )
    ...
    async def send_text_message(
        self, recipient_id: Text, message: Text
    ) -> None:
        """Send a message through this channel."""

        raise NotImplementedError(
            "Output channel needs to implement a send "
    ...
    async def send_image_url(self, recipient_id: Text, image_url: Text) -> None:
        ...
        await self.send_text_message(
            recipient_id, "Image: {}".format(image_url)
        )

    async def send_attachment(
        self, recipient_id: Text, attachment: Text
    ) -> None:
        """Sends an attachment. Default will just post as a string."""

        await self.send_text_message(
            recipient_id, "Attachment: {}".format(attachment)
        )
    ...
    async def send_quick_replies(
        ...
        **kwargs: Any
        ...
        await self.send_text_with_buttons(
            recipient_id, message, buttons, **kwargs
        )
...
class CollectingOutputChannel(OutputChannel):
    ...
    @staticmethod
    def _message(
        recipient_id, text=None, image=None, buttons=None, attachment=None
    ):
    ...
    async def send_text_with_buttons(
        self, recipient_id, message, buttons, **kwargs
    ):
        await self._persist_message(
    ...
    async def send_image_url(self, recipient_id: Text, image_url: Text) -> None:
        ...
        await self._persist_message(
            self._message(recipient_id, image=image_url)
        )
    ...
    async def send_attachment(
        ...
        await self._persist_message(
            self._message(recipient_id, attachment=attachment)
        )
